...
//   {
//     image: "/assets/mainpage/banner-campaign.jpg",
//     label: "Limited Time Offer",
//     description: "Discover Savings: Shop our Latest Campaign!",
//   },
//   {
//     image: "/assets/mainpage/banner-newcollection.jpg",
//     label: "Our Latest Collection",
//     description: "Be the First to Shop Our New Collection",
//   },
//   {
//     image: "/assets/mainpage/banner-sale.jpg",
//     label: "Sale Ends Soon!",
//     description: "Don't Miss Out on Our Exclusive Sale!",
//   },
// ];

export const giftData: IGiftData[] = [
  {
...
export const popularCategories: IPopularCategories[] = [
  {
...
export const footerData: IFooterData[] = [
  ...
  {
    section: "ABOUT US",
    menuItems: ["About us", "News", "Careers", "Investors", "Sustainability"],
  },
  {
    section: "PRIVACY & SECURITY",
    menuItems: ["Privacy policy", "Security policy", "Terms of use"],
  },
  {
    section: "QUICK LINKS",
    menuItems: ["Home", "Categories", "Deals and promotions", "Order tracking"],
  },
];
